Sub ExportCommentsToExcel()
    ...
    With xlWB.Worksheets(1)
        ...
        .Cells(1, 4).Value = "Reference Text"
        .Cells(1, 5).Value = "Comment Text"
    End With
    ...
    For i = 1 To ActiveDocument.Comments.Count
        ...
        pageNumber = commentRange.Information(wdActiveEndPageNumber) ' Get the page number
        ...
        With xlWB.Worksheets(1)
            ...
            .Cells(i + 1, 3).Value = pageNumber
            .Cells(i + 1, 4).Value = referenceText
